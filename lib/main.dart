    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: TabNavigator(
          key: _tabNavigator,
          tabs: <TabItem>[
            TabItem(_tab1, PageContainer(title: 'Audio')),
            TabItem(_tab2, OtherPage()),
            TabItem(_tab3, PageContainer(title: 'More')),
          ],
      ...
      body: Row(
        children: [
          ...
          RaisedButton(
            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => PageContainer(title: "title", count: 3 + 1),
              ));
            },
          ),
        ],
    ...
    return Scaffold(
      ...
      body: Center(
        child: RaisedButton(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(
              builder: (_) => PageContainer(title: title, count: count + 1),
            ));
          },
        ),
      ),
